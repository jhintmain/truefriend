...
public class JusoAPIService {
    ...
    public static final String API_URL = "https://business.juso.go.kr/addrlink/addrLinkApi.do?";     // 요청 주소 URL
     ...
     *
     * @param jsonAddress
     * TODO : https://soulduse.tistory.com/22 JSON TO OBJECT
     */
    ...
    public void makeJusoData(String address, boolean flag) throws IOException {
        ...
        // 주소 정보 txt로 저장
        File fileResult = new File("src/data/juso_data_api.txt");
